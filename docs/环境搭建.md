- [ docker系列](#head1)
	- [ 命令](#head2)
	- [ 安装docker](#head3)
		- [ 安装docker和redis](#head4)
		- [ 安装kafka](#head5)
		- [ 安装elasticsearch](#head6)
		- [ 安装tomcat（需要修改）](#head7)
		- [ 安装nginx](#head8)
		- [ 安装mysql](#head9)
		- [ 安装fastDFS](#head10)
...
## <span id="head1"> docker系列</span>

### <span id="head2"> 命令</span>
...
#### <span id="head4"> 安装docker和redis</span>
...
#### <span id="head6"> 安装elasticsearch</span>
...
#### <span id="head7"> 安装tomcat（需要修改）</span>
