...
//import site.pyyf.community.service.CloudPanService;
//
...
//    private CloudPanService cloudPanService;
//
...
//            cloudPanService.insertFileSystem(dirname, absolute_path + "*" + dirname);
//
//        } else {
//            page.setPath("/shareFiles/show" + page.getPath());
//            cloudPanService.insertFileSystem(realPath + "/" + dirname, absolute_path + "*" + dirname);
//        }
//
//
...
//
//
//        int size = cloudPanService.fileSize(absolute_path.replace("*", "/"));
//        page.setRows(size);
//
//        // files = {"dir1*dir2*dir3"}
//        List<File> files = cloudPanService.list(page.getCurrent(), page.getLimit(), absolute_path.replace("*", "/"));
//
//        model.addAttribute("files", files);
//        model.addAttribute("absolute_path", absolute_path);
...
//            int result = cloudPanService.deleteFileSystem(absolute_path);
//        }
//        return "redirect:/shareFiles/show/index";
//    }
//
...
//            int result = cloudPanService.modifyFileSystem(absolute_path, modified_path);
//        }
//        return "redirect:/shareFiles/show/index";
//    }
//
