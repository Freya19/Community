...
@Deprecated
//@Component
public class EventConsumer_kafka extends BaseController implements CommunityConstant {

    @Autowired
    protected TemplateEngine templateEngine;

    private static final Logger logger = LoggerFactory.getLogger(EventConsumer_kafka.class);
